...
function createListComponent({ getItemOffset, getEstimatedTotalSize, getItemSize, getOffsetForIndexAndAlignment, getStartIndexForOffset, getStopIndexForStartIndex, initInstanceProps, shouldResetStyleCacheOnItemSizeChange, validateProps }) {
    ...
    return _a = class List extends react_1.PureComponent {
            ...
            constructor(props) {
                ...
                this._callOnItemsRendered = memoize_one_1.default((overscanStartIndex, overscanStopIndex, visibleStartIndex, visibleStopIndex) => this.props.onItemsRendered({
                    overscanStartIndex,
                    overscanStopIndex,
                    visibleStartIndex,
                    visibleStopIndex
                }));
                this._callOnScroll = memoize_one_1.default((scrollDirection, scrollOffset, scrollOffsetToBottom, scrollUpdateWasRequested) => this.props.onScroll({
                    scrollDirection,
                    scrollOffset,
                ...
                this._getItemStyleCache = memoize_one_1.default(() => ({}));
                ...
                this._resetIsScrollingDebounced = () => {
                    if (this._resetIsScrollingTimeoutId !== null) {
                        timer_1.cancelTimeout(this._resetIsScrollingTimeoutId);
                    }
                    this._resetIsScrollingTimeoutId = timer_1.requestTimeout(this._resetIsScrolling, IS_SCROLLING_DEBOUNCE_INTERVAL);
                };
            ...
            render() {
                const { children, outerClassName, innerClassName, height, innerRef, innerElementType, innerTagName, itemCount, itemData, itemKey = defaultItemKey, outerElementType, outerTagName, style, useIsScrolling, width, isTextWrapped, hasLineNumbers, ansiUp } = this.props;
                ...
                return react_1.createElement(outerElementType || outerTagName || 'div', {
                ...
                }, react_1.createElement(innerElementType || innerTagName || 'div', {
